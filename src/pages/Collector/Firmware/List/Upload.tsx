...
import { Modal, Form, Input, Button, Divider, Radio, Upload, UploadProps, notification } from 'antd';
  ...
  return (
    <Modal
      footer={[
        ...
        <Button type="primary" loading={isMutating} form="firmwareUpdate" key="submit" htmlType="submit">
          提交
        </Button>,
      ]}
      title="上传固件"
